    ...
    <div className="drawer">
      ...
      <div className="drawer-side z-[999]">
        ...
        <ul className="menu bg-base-300 min-h-full w-80 p-4">
          ...
          <li>
            <Link to="/login" className="hover:bg-accent hover:text-accent-content">Login</Link>
          </li>
          <li>
            <Link to="/register" className="hover:bg-accent hover:text-accent-content">Register</Link>
          </li>
          <li>
            <Link to="/profile" className="hover:bg-accent hover:text-accent-content">My Profile</Link>
          </li>
          <li>
            <Link to="/admin" className="hover:bg-accent hover:text-accent-content">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
