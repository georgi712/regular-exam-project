                ...
                >
                  <li>
                    <Link
                      ...
                      className="text-base-content hover:bg-accent hover:text-accent-content"
                    >
                      Fruits
                    </Link>
                  </li>
          ...
          <div className="flex-none flex gap-2 ml-auto">
            ...
            <div className="dropdown dropdown-end">
              <div
                tabIndex={0}
                role="button"
                className="btn btn-ghost btn-circle hover:bg-accent hover:text-accent-content"
              >
            ...
            <div className="dropdown dropdown-end">
              ...
              <ul
                tabIndex={0}
                className="dropdown-content z-[1] menu menu-sm bg-base-100 text-base-content rounded-box w-52 p-2 shadow mt-3"
              >
                {!accessToken ? (
                  <>
                    <li>
