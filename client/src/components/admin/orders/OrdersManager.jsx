      ...
      {viewOrderId && (
        <div className="modal modal-open modal-bottom sm:modal-middle">
          <div className="modal-box w-11/12 max-w-5xl">
            {(() => {
              const order = getOrderById(viewOrderId);
              return (
                <>
                  <div className="flex justify-between items-center mb-6 pb-3 border-b">
                    <h3 className="font-bold text-lg">Order Details - {order.id}</h3>
                    <button className="btn btn-sm btn-circle" onClick={() => setViewOrderId(null)}>✕</button>
                  </div>
                  ...
                  <div className="modal-action pt-4 border-t">
                    <button className="btn btn-ghost" onClick={() => setViewOrderId(null)}>Close</button>
                  </div>
                </>
              );
            })()}
